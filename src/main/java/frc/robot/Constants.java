...
public class Constants {
    ...
    static{
        ...
        tmp.put("note", new Translation2d(0,0));
    ...
    static{
      ...
      final double ids_1_2_5_6_9_10_Height = 1.355852;//group 1   *
      final double ids_3_4_7_8_Height = 1.451102;// gorup 2   #
      final double ids_11_12_13_14_15_16_Height =1.3208;// group 3 !
      
      final HashMap<Double,Double> idToHeights = new HashMap<>();
  
      idToHeights.put(1.0,ids_1_2_5_6_9_10_Height);//   *
      idToHeights.put(2.0,ids_1_2_5_6_9_10_Height);//   *
  
      idToHeights.put(3.0,ids_3_4_7_8_Height);//  #
      idToHeights.put(4.0,ids_3_4_7_8_Height);//  #
  
      idToHeights.put(5.0,ids_1_2_5_6_9_10_Height);
      idToHeights.put(6.0,ids_1_2_5_6_9_10_Height);
  
  
      idToHeights.put(7.0,ids_3_4_7_8_Height);//  #
      idToHeights.put(8.0,ids_3_4_7_8_Height);//  #
  
      idToHeights.put(9.0,ids_1_2_5_6_9_10_Height);//   *
      idToHeights.put(10.0,ids_1_2_5_6_9_10_Height);//  *
  
      idToHeights.put(11.0,ids_11_12_13_14_15_16_Height);// !
      idToHeights.put(12.0,ids_11_12_13_14_15_16_Height);// !
      idToHeights.put(13.0,ids_11_12_13_14_15_16_Height);// !
      idToHeights.put(14.0,ids_11_12_13_14_15_16_Height);// !
      idToHeights.put(15.0,ids_11_12_13_14_15_16_Height);// !
      idToHeights.put(16.0,ids_11_12_13_14_15_16_Height);// !
  
      idToHeights.put(-1.0,0.0);
      idToHeights.put(0.0,0.0);
      //note id is not known so it is 0.0
      

      HEIGHT_MAP = Collections.unmodifiableMap(idToHeights);
    }
    public static final double LimelightHight = 0.3;
    public static final double LimelightAngle = 51.317812;
}
