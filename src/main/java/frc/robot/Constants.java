...
public final class Constants {
  ...
  public static final double spinPerMeter = (Radios*2)*Math.PI;//the gear ratio is 1 in motor up and motordown
  public static final double meterPerSpin = 1/spinPerMeter;
